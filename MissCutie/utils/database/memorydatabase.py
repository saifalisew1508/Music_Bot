...
from MissCutie.core.mongo import mongodb
...
videodb = mongodb.MissCutievideocalls
...
async def is_video_allowed(chat_idd) -> str:
    ...
    return bool(count != int(limit) or await is_active_video_chat(chat_idd))
