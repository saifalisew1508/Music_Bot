...
import config
from MissCutie import Carbon, YouTube, app
from MissCutie.core.call import MissCutie
from MissCutie.misc import db
from MissCutie.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from MissCutie.utils.exceptions import AssistantErr
from MissCutie.utils.inline.play import (stream_markup,
                                          telegram_markup)
from MissCutie.utils.inline.playlist import close_markup
from MissCutie.utils.pastebin import MissCutiebin
from MissCutie.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await MissCutie.force_stop_stream(chat_id)
