...
from MissCutie.utils.database import get_authuser_names, get_cmode
from MissCutie.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MissCutie.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await MissCutie.stop_stream(message.chat.id)
    except:
        pass
