...
from MissCutie.plugins.MissCutie.database.limitsdb import is_approved
import random
import string
...
from MissCutie import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from MissCutie.core.call import MissCutie
from MissCutie.utils import seconds_to_min, time_to_seconds
from MissCutie.utils.channelplay import get_channeplayCB
from MissCutie.utils.database import is_video_allowed
from MissCutie.utils.decorators.language import languageCB
from MissCutie.utils.decorators.play import PlayWrapper
from MissCutie.utils.formatters import formats
from MissCutie.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from MissCutie.utils.inline.playlist import botplaylist_markup
from MissCutie.utils.logger import play_logs
from MissCutie.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await MissCutie.stream_call(url)
...
@app.on_callback_query(
    filters.regex("MissCutiePlaylists") & ~BANNED_USERS
)
@languageCB
