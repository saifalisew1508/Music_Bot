...
COMMANDS_BUTTON_USER = InlineKeyboardMarkup(
    [   [
        ...
        [
            InlineKeyboardButton(
                text="Play Commands", url="https://telegra.ph/MissCutie-Music-Bot-Commands-11-07"
            ),            
            InlineKeyboardButton(
                text="Extra Commands", url="https://telegra.ph/MissCutie-Music-Bot-Extra-Commands-11-07"
            ),                                   
        ],
        [
            InlineKeyboardButton(
...
COMMANDS_BUTTON_SUDO = InlineKeyboardMarkup(
    [   [
        ...
        [
            ...
            InlineKeyboardButton(
                text="Sudo Commands", url="https://telegra.ph/MissCutie-Music-Bot-Sudo-Commands-11-07"
            ),            
        ],
        [
            InlineKeyboardButton(
